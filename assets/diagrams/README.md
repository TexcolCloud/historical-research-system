...
| 内容 | 实现 |
| --- | --- |
| 阶段顺序、人工信号等待、自动制卡开关、删除任务 | [workflows.py](../../services/research-platform/src/hrs_platform/workflows.py) |
| OCR 检查点、模型核验与阶段产物 | [activities.py](../../services/research-platform/src/hrs_platform/activities.py) |
| 工作流注册、队列、outbox 派发 | [worker.py](../../services/research-platform/src/hrs_platform/worker.py) |
| 查询嵌入、重排与索引代际 | [search.py](../../services/research-platform/src/hrs_platform/search.py) |
