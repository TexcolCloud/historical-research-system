...
from hrs_platform.services.outputs import Outputs, StageInputMismatch, execution_parent, fingerprint
        ...
        async def record_request(request):
            ...
            try:
                ...
                if tools:
                    ...
                    from hrs_platform.services.reading import CARD_INPUT_TOKENS
